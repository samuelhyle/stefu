...
function AdminRoute({ user, loading, onAuthSuccess }) {
...
function AppInner() {
  ...
  const [authRequiredCallback, setAuthRequiredCallback] = useState(null)
  ...
  const handleAuthRequired = useCallback((callback) => {
