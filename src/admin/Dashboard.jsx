...
import { Plus, Edit, Trash2, X, Upload, Play, Eye, Clock, Save, ChevronRight } from 'lucide-react'
import { supabase, isSupabaseConfigured } from '../lib/supabase'
import { getMuxPlaybackUrl, getMuxThumbnailUrl } from '../lib/mux'

const CATEGORIES = ['trending', 'exclusive', 'lifestyle', 'talks']
const TYPES = ['live', 'episode', 'clip']
const TIMELINE_SLOTS = ['morning', 'afternoon', 'evening', 'night', null]
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  >
                    ...
                    {TIMELINE_SLOTS.filter(Boolean).map((slot) => (
