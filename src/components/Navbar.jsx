...
export default function Navbar({ activeSection, setActiveSection, allContent = [] }) {
      ...
      <AnimatePresence>
        {mobileMenuOpen && (
          <motion.div
            ...
            className="md:hidden bg-obsidian-300/95 backdrop-blur-lg border-t border-white/5"
          >
