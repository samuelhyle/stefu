        ...
        <div className="grid md:grid-cols-4 gap-12">
          <div className="col-span-2">
            ...
            <p className="mt-4 text-white/60 max-w-md leading-relaxed">
              Step into the world of Stefan Therman. Exclusive content, live streams,
              the Sober Life Store — and a community built on discipline and ambition.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3 text-white/50">
              {['Live', 'Episodes', 'Moments', 'Podcasts', 'Vlog', 'Music / Radio', 'Store'].map((item) => (
                <li key={item}>
