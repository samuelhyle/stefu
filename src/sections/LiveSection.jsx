      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-white/60 max-w-2xl mx-auto">
            Experience Stefan's day in real-time. Watch exclusive live content 
            as it happens throughout the day.
          </p>
        </motion.div>
            ...
            <div className="bg-obsidian-200/50 backdrop-blur-sm rounded-2xl p-4 border border-white/5">
              ...
              <div className="space-y-2">
                {timeline.map((item, index) => {
                  ...
                  const isActive = currentHour >= hour && (index === timeline.length - 1 || currentHour < timeline[index + 1].time.split(':').map(Number))
