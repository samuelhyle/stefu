...
export default function PremiumSection({ onJoinCircle }) {
  return (
          ...
          <div className="relative z-10 py-16 px-8 md:px-16">
            <div className="max-w-2xl">
              ...
              <p className="text-xl text-white/70 mb-10 leading-relaxed">
                Get exclusive access to private streams, behind-the-scenes content, 
                and direct interactions with Stefan. Limited memberships available.
              </p>
              <div className="flex flex-wrap gap-4">
                <motion.button
                  onClick={onJoinCircle}
                  className="btn-gold text-lg px-10 py-4 shadow-xl shadow-gold-500/30"
                ...
                <motion.button
                  className="btn-outline text-lg px-10 py-4 border-white/30 text-white hover:bg-white/10 hover:border-white"
                  whileHover={{ scale: 1.05 }}
                  whileTap={{ scale: 0.95 }}
                >
                  Learn More
