      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-white/60 max-w-2xl mx-auto">
            A story of ambition, power, and relentless pursuit of excellence —
            built on discipline, refined by experience.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center mb-16">
          ...
          >
            <h3 className="text-3xl font-display font-bold text-white">
              The Corleone Legacy, the Scarface Vision
            </h3>
            <p className="text-white/70 leading-relaxed">
              Like a modern-day Michael Corleone, Stefan has built an empire through strategic
              thinking, unwavering discipline, and an uncompromising vision — the ambition of
              Tony Montana, refined with Finnish precision and elegance.
            </p>
            <p className="text-white/70 leading-relaxed">
              ...
              The Sober Life is a code — and the code never sleeps.
            </p>
            <p className="text-gold-500 font-semibold text-lg italic">
