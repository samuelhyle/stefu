      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-white/60 max-w-2xl mx-auto">
            Hard-won lessons from a life of discipline. Apply these principles
        ...
        >
          ...
          <p className="text-white/60 mb-6 max-w-lg mx-auto">
            Inner Circle members receive exclusive playbook chapters, personal
            coaching sessions, and direct insights from Stefan.
          </p>
          <motion.button
