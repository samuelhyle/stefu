...
interface MusicRadioSectionProps { onVideoSelect?: (content: any) => void }

export default function MusicRadioSection({ onVideoSelect }: MusicRadioSectionProps) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-white/60 max-w-2xl mx-auto">
            The soundtrack of the legend&apos;s world — stream original music
            and exclusive radio, 24 hours a day, 7 days a week.
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          ...
          >
            ...
            <p className="text-white/60 text-sm mb-4">
              Curated playlists and original tracks from Stefan. Experience the
              soundtrack of a life lived at legendary levels.
            </p>
