...
const chatMessages = [
  { user: 'Stefan_Fan_01', message: 'Just watched the latest episode — legendary as always.', time: '2m ago' },
  { user: 'InnerCircle_Mike', message: 'The behind-the-scenes content is on another level', time: '5m ago' },
  { user: 'Stefu_Legend', message: 'Following since day one. The growth is real.', time: '8m ago' },
...
const communityFeatures = [
  {
    icon: MessageCircle,
    title: 'Live Chat',
    description: 'Real-time discussions about content, events, and Stefan\'s latest moves.',
    color: 'text-blue-400',
  ...
  },
  {
    ...
    description: 'Exclusive glimpses into the making of the content — what really happens behind the window.',
  ...
  },
  {
    icon: Users,
    title: 'Inner Circle',
    description: 'Direct access to Stefan and a community of serious, ambitious members.',
    color: 'text-gold-400',
  ...
  },
  {
    icon: Sparkles,
    title: 'First Access',
    description: 'Be first to know about new releases, Sober Life Store drops, and major announcements.',
    color: 'text-pink-400',
    bgColor: 'bg-pink-500/20',
  },
]

export default function CommunitySection({ onJoinCircle }: { onJoinCircle?: () => void }) {
  return (
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-xl text-white/60 max-w-2xl mx-auto">
            What happens behind the window? Find out. Connect with fellow followers
            and get exclusive access to the inner circle.
          </p>
        </motion.div>
            ...
            <div className="p-4 border-t border-white/5">
              <div className="flex items-center space-x-3">
                <input
                  ...
                  className="flex-1 px-4 py-2 rounded-xl bg-obsidian-200/50 border border-white/10 text-white text-base placeholder-white/40 focus:outline-none focus:border-gold-500/50"
                />
                <motion.button
