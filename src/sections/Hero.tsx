...
export default function Hero({ onWatchLive, onExplore }: HeroProps) {
  return (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <div className="max-w-3xl">
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl md:text-8xl font-display font-bold mb-6 leading-none tracking-tight"
            >
            ...
            <motion.p
              ...
              className="text-lg md:text-2xl text-white/70 mb-4 font-light"
            >
              Power. Presence. Purpose.
            </motion.p>
            ...
            >
              A front-row seat to the life of Finland&apos;s most ambitious legend.
              Exclusive content, unfiltered moments, and the Sober Life Store —
              only for those who demand more.
            </motion.p>
            ...
            >
              <motion.button
                className="btn-gold text-base md:text-lg px-8 py-4 flex items-center justify-center space-x-3 shadow-xl shadow-gold-500/30"
              ...
              <motion.button
                className="btn-outline text-base md:text-lg px-8 py-4 flex items-center justify-center space-x-3"
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                onClick={onExplore}
              >
