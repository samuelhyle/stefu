              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div>
                  <input
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl bg-obsidian-300/50 border border-white/10 text-white placeholder-white/40 focus:outline-none focus:border-gold-500/50 transition-colors"
                  />
                </div>
                <div>
                  <input
                ...
                <div>
                  <textarea
                    ...
                    required
                    className="w-full px-4 py-3 rounded-xl bg-obsidian-300/50 border border-white/10 text-white placeholder-white/40 focus:outline-none focus:border-gold-500/50 transition-colors resize-none"
                  />
                </div>
                <motion.button
                  type="submit"
